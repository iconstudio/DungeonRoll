...
for (i = 0; i < menu_number; ++i) {
	...
	if i == menu_mode {
		...
		draw_rectangle(menu_draw_x, menu_frame_menu_height, menu_draw_x + menu_draw_width, menu_frame_menu_height + menu_frame_indicator_height, false)
		draw_set_color(0)
	}
