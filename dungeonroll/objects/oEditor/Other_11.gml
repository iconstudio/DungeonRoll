...
editor_submenu_add(menu_setting, "격자 끄기", -1, editor_callback_grid_off)
editor_submenu_add(menu_setting, "반전", -1, editor_callback_grid_inverse)
editor_submenu_add(menu_setting, "노랑", -1, editor_callback_grid_yellow)
editor_submenu_add(menu_setting, "빨강", -1, editor_callback_grid_red)
editor_submenu_add(menu_setting, "하양", -1, editor_callback_grid_white)
