...
var dodecahedron_angle = menu_rotation + menu_rotation_push
...
draw_transform_add_rotation_y(dodecahedron_angle)
...
for (var i = 0; i <= menu_depth_max; ++i) {
	...
	var menu_cosine = dcos(menu_render_angle)
	...
	//var menu_render_angle_vertical = abs(menu_cosine) * menu_perspective_angle_gap + menu_perspective_angle_s
	var menu_render_angle_horizontal = menu_perspective_angle_s
	var menu_render_angle_vertical = menu_perspective_angle_s
	
	var menu_render_distance_horizontal = abs(menu_cosine) * menu_item_render_distance_gap + menu_item_render_distance_s
	//var menu_render_distance_vertical = abs(menu_cosine) * menu_item_render_distance_gap + menu_item_render_distance_s
	var menu_render_distance_vertical = menu_item_render_distance_s
	...
	draw_transform_set_translation(0, 0, -menu_render_distance_vertical)
	draw_transform_add_rotation_x(menu_render_angle_vertical)
	draw_transform_add_rotation_y(menu_render_angle)
	draw_text(0, 0, menu_info_up[0])
	draw_transform_set_identity()

	draw_transform_set_translation(0, 0, -menu_render_distance_vertical)
	draw_transform_add_rotation_x(360 - menu_render_angle_vertical) // -45
	draw_transform_add_rotation_y(menu_render_angle)
